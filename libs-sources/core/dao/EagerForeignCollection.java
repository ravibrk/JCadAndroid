 ...
 * @author graywatson
 */
public class EagerForeignCollection<T extends Model, ID> extends BaseForeignCollection<T, ID> implements ForeignCollection<T>,
	...
	public EagerForeignCollection(Dao<T> dao, Object parent, Object parentId, FieldType foreignFieldType,

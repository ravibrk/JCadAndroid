 ...
 * @author graywatson
 */
public abstract class BaseForeignCollection<T extends Model, ID> implements ForeignCollection<T>, Serializable {

	private static final long serialVersionUID = -5158840898186237589L;

	protected transient final Dao<T> dao;
	...
	protected BaseForeignCollection(Dao<T> dao, Object parent, Object parentId, FieldType foreignFieldType,

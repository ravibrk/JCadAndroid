...
import ormlite.core.field.DatabaseFieldConfig;
import ormlite.core.field.FieldType;
import ormlite.core.misc.JavaxPersistence;
...
public class DatabaseTableConfig<T> {
	 ...
	 */
	public static <T extends Model> DatabaseTableConfig<T> fromClass(ConnectionSource connectionSource, Class<T> clazz)
			throws SQLException {

...
import ormlite.core.stmt.query.Between;
import ormlite.core.stmt.query.Clause;
import ormlite.core.stmt.query.Exists;
import ormlite.core.stmt.query.In;
import ormlite.core.stmt.query.InSubQuery;
import ormlite.core.stmt.query.IsNotNull;
import ormlite.core.stmt.query.IsNull;
import ormlite.core.stmt.query.ManyClause;
import ormlite.core.stmt.query.NeedsFutureClause;
import ormlite.core.stmt.query.Not;
import ormlite.core.stmt.query.Raw;
import ormlite.core.stmt.query.SimpleComparison;
...
import ormlite.core.stmt.PreparedStmt;
 ...
 * @author graywatson
 */
public class Where<T extends Model, ID> {
	...
	Where(TableInfo<T> tableInfo, StatementBuilder<T, ID> statementBuilder, DatabaseType databaseType) {
	...
	public Where<T, ID> idEq(Dao<T> dataDao, Where<T, ID> data) throws SQLException {
		if (idColumnName == null) {
			throw new SQLException("Object has no id column specified");
		}
		addClause(new SimpleComparison(idColumnName, idFieldType, dataDao.extractId((T) data),
				SimpleComparison.EQUAL_TO_OPERATION));
		return this;
	}
	...
	public PreparedQuery<T> prepare() throws SQLException {
		return (PreparedQuery<T>) statementBuilder.prepareStatement(null);
	}
	...
	private Where<T, ID> in(boolean in, String columnName, QueryBuilder<? extends Model, ?> subQueryBuilder) throws SQLException {

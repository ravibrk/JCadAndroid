...
import ormlite.core.stmt.query.SetExpression;
import ormlite.core.stmt.query.SetValue;
 ...
 * @author graywatson
 */
public class UpdateBuilder<T extends Model, ID> extends StatementBuilder<T, ID> {

	private List<Clause> updateClauseList = null;
	// NOTE: anything added here should be added to the clear() method below

	public UpdateBuilder(DatabaseType databaseType, TableInfo<T> tableInfo, Dao<T> dao) {

 ...
 * @author graywatson
 */
public class SelectIterator<T extends Model, ID> implements CloseableIterator<T> {

	private final static Logger logger = LoggerFactory.getLogger(SelectIterator.class);

	private final Class<?> dataClass;
	private final Dao<T> classDao;
	 ...
	 */
	public SelectIterator(Class<?> dataClass, Dao<T> classDao, GenericRowMapper<T> rowMapper,

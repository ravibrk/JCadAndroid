...
import ormlite.core.stmt.query.OrderBy;
 ...
 * @author graywatson
 */
public class QueryBuilder<T extends Model, ID> extends StatementBuilder<T, ID> {
	...
	public QueryBuilder(DatabaseType databaseType, TableInfo<T> tableInfo, Dao<T> dao) {
	...
	public PreparedQuery<T> prepare() throws SQLException {
		return (PreparedQuery<T>) super.prepareStatement(limit);
	}
	...
	public GenericRawResults<String[]> queryRaw() throws SQLException {
		return (GenericRawResults<String[]>) dao.queryRaw(prepareStatementString());
	}
	...
	public CloseableIterator<T> iterator() throws SQLException {
		return (CloseableIterator<T>) dao.iterator(prepare());
	}

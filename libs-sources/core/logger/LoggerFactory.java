 ...
 * 
 * <p>
 * To set the logger to a particular type, set the system property ("ormlite.core.logger.type") contained in
 * {@link #LOG_TYPE_SYSTEM_PROPERTY} to be one of the values in LogType enum.
 * </p>
 */
public class LoggerFactory {

	public static final String LOG_TYPE_SYSTEM_PROPERTY = "ormlite.core.logger.type";
	...
	public enum LogType {
		 ...
		 */
		ANDROID("android.util.Log", "ormlite.core.android.AndroidLog"),
		SLF4J("org.slf4j.LoggerFactory", "ormlite.core.logger.Slf4jLoggingLog"),
		COMMONS_LOGGING("org.apache.commons.logging.LogFactory", "ormlite.core.logger.CommonsLoggingLog"),
		LOG4J2("org.apache.logging.log4j.LogManager", "ormlite.core.logger.Log4j2Log"),
		LOG4J("org.apache.log4j.Logger", "ormlite.core.logger.Log4jLog"),

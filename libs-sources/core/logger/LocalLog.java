...
public class LocalLog implements Log {
	...
	public static final String LOCAL_LOG_LEVEL_PROPERTY = "ormlite.core.logger.level";
	public static final String LOCAL_LOG_FILE_PROPERTY = "ormlite.core.logger.file";

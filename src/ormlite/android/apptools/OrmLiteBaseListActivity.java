 ...
 */
public abstract class OrmLiteBaseListActivity<MODEL extends Model, DAO extends Dao<MODEL, Long>, H extends OrmLiteSqliteOpenHelper> extends ListActivity {
	...
	public ConnectionSource getConnectionSource() {
		return (ConnectionSource) getHelper().getConnectionSource();
	}
